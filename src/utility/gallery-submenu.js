    ...
    return (
        <>
            <motion.div initial={{ x: "-900%" }} animate={{ x: 0 }} transition={{ delay: 0.5, duration: 1.5, type: "spring", bounce: 0.1 }} exit={{ x: "900%" }} className={classes.menu_main}>
                <li ><div className={classes.menuMain__links} onClick={props.GallerySubMenu__AzoresHandler} >Azores</div></li>
                <li ><div className={classes.menuMain__links} onClick={props.GallerySubMenu__OceanHandler} >Oceans</div></li>
